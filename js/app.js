     ...
     const trainBtn = document.getElementById('train-btn');
      ...
      trainBtn.addEventListener('click', () => {
          if (trainRunning) {
              ...
              const intervalMs = parseInt(trainIntervalInput.value) || 30;
              console.log('Starting training with current state...');
              stopTraining = startTraining(intervalMs, () => {
                  console.log('Training stopped.');
              });
              trainRunning = true;
              trainBtn.textContent = 'Stop Train';
          }
      });
